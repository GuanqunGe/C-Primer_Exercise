...
int main(int argc, char **argv){
    ...
    std::ofstream outfile(argv[2]); //implicitly, file is open in out+truncate mode
    if(!outfile){
	...
	print(outfile, total);
	//print(outfile, total) << std::endl; // buffer will be flushed at the end of program execution
    }else{
