//simply change the appearance of std::map to std::unordered_map in ex_11_3.cxx
#include <iostream>
#include <fstream>
#include <string>
...
void Counter(std::istream &is, std::unordered_map<std::string, unsigned> &map){
...
std::ostream &Printer(std::ostream &os, const std::unordered_map<std::string, unsigned> &map){
